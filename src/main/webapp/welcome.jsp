						...
						<div class="row" style="margin-top: 2%">
							<div class="col-md-2">
								<div class="list-group" style="margin-left: -30px">
									<a class="list-group-item" href="#" onclick="confgFunction()"><i
										class="fa fa-credit-card"></i> &nbsp; Configuration</a> <a
										class="list-group-item" href="#"
										onclick="PerformanceFunction()"><i class="fa fa-users"></i>
										&nbsp; PerformanceFunction </a> <a
										class="list-group-item settingsActive" href="#"
										onclick="payLoadFunction()"> <i class="fa fa-wifi"></i>
										&nbsp; Payload Trace
										...
										<div class="table-responsive">
											<table class="table table-striped ">
												...
												<c:forEach var="allUserDetails" items="${allUserDetails}">
													<tr>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.srNo}</td>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.dateandTime}</td>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.hostname}</td>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.responseCode}</td>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.request_Method}</td>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.ip}</td>
														<td class="dashtdValue" style="padding-top: 1%"
															onclick="requestFunction()">${allUserDetails.requestUri}</td>
