...
</script><style type="text/css">.focus {
							...
							<div class="col-md-2">
								<div class="list-group" style="margin-left: -30px">
									<a class="list-group-item" href="#"
										...
										&nbsp; Configuration</a> <a class="list-group-item settingsActive" href="#"
										...
										<div class="table-responsive">
											<table class="table table-striped ">
												...
												<c:forEach var="allUserDetails" items="${allUserDetails}">
													<tr>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.class_name}</td>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.requestUri}</td>
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.operation_name}</td>
														...
														<td class="dashtdValue" style="padding-top: 1%">${allUserDetails.timeDiffirence}</td>
