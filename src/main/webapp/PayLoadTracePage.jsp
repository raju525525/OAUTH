						...
						<table>
							<thead>
								<tr>
									...
									<th nowrap="nowrap">ServiceName</th>
									<th nowrap="nowrap">OperationName</th>
							...
							<tbody id="mainBody">
								<c:forEach items="${allUserDetails}" var="allUserDetails">
									<tr>
										<td>${allUserDetails.class_name}</td>
										<td>${allUserDetails.requestUri}</td>
										<td>${allUserDetails.operation_name}</td>
